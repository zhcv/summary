...
Flask-Cors example
==================
This is a tiny Flask Application demonstration Flask-Cors, making it simple
...
# one of simplest configurations. Exposes all resources matching /api/* to
...
def create_user():
    """
        ...
        Browers will first make a preflight request to verify that the resource
        allows cross-origin POSTs with a JSON Contenst-Type, which can be simulated
        as:
        ...
        Date: Tues, 8 May 2018 13:29:12 GMT
        ...
        Access-Control-Allow-Origin: *
        Server: Werkzeug/0.9.6 Python/2.7.9
        Date Tues, 8 May 2018 13:30:58 GMT
...
def get_exception():
    """
	 Since the path matches the regular expression r'/api/*', this resource
        ...
        Content-Length: 0
        Server: Werkzeug/0.9.6 Python/2.7.9
        Date: Tues, 5 May 2018 13:37:22 GMT
    """
...
def server_error(e):
    logging.exception("An error occured during a request. %s", e)
